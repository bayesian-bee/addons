...
data.item_fishing_parameters = {
    ...
    {name='titanic sawfish', id=5120, stamina=80, arrow_duration=9, arrow_frequency=14, stamina_depletion=39, size=1, legendary=1},
    ...
    {name='ryugu titan', id=4305, stamina=85, arrow_duration=4, arrow_frequency=16, stamina_depletion=48, size=1, legendary=1},
